...
The widget houses many properties that allow us to tamper with the displayed map and customize it accordingly. Now, to install this plugin, we run command
